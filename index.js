  ...
  let georgianCities = [
    {
      ...
      description:
        "Tbilisi, the capital of Georgia, is known for its diverse architecture, historic churches, and vibrant arts scene. It sits on the banks of the Kura River and offers a mix of modern and historic attractions.",
    },
    {
      id: 2,
      title: "Batumi",
      ...
      description:
        "Batumi, a seaside city on the Black Sea coast, is famous for its beaches, botanical garden, and modern architecture. It's a popular tourist destination with a subtropical climate.",
    },
    {
      id: 3,
      title: "Kutaisi",
      ...
      description:
        "Kutaisi, Georgia's second-largest city, is known for its historical and architectural heritage. It's home to the Bagrati Cathedral and the Gelati Monastery, both UNESCO World Heritage Sites.",
    },
    {
      id: 4,
      title: "Gori",
      ...
      description:
        "Gori is the birthplace of Joseph Stalin and is known for its Stalin Museum. The city is also home to the ancient Uplistsikhe Cave Town and the Gori Fortress.",
    },
    {
      id: 5,
      title: "Mtskheta",
      ...
      description:
        "Mtskheta, one of the oldest cities in Georgia, is a UNESCO World Heritage Site. It's known for its historical and religious significance, with attractions like the Svetitskhoveli Cathedral and Jvari Monastery.",
    },
    {
      id: 6,
      title: "Zugdidi",
      ...
      description:
        "Zugdidi is a city in western Georgia, known for its lush landscapes and the Dadiani Palace, which houses a museum. The city is a gateway to the beautiful Samegrelo region.",
    },
  ];
    ...
    setTimeout(() => {
      for (let i = 0; i < georgianCities.length; i++) {
        if (i < currentIndex || i >= currentIndex + citiesPerPage) {
          let city = citiesWrapper.children[i - currentIndex];
          if (city) {
    ...
    .then((result) => {
      ...
      function renderItems() {
        ...
        let filteredResult = result.filter(
          (element) => element.userId === counter,
        );
